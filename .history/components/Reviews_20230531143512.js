                ...
                <div className="flex flex-wrap -m-4 px-20">
                    ...
                    <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                        <div className="h-full text-center">
                            ...
                            <p className="leading-relaxed">Ich verdanke diese Plattform die Zukunft meines Kindes, da es meinem Kind geholfen hat, nur 6er in der Schule zu schreiben. Und das Beste ist - Sie verwendet </p>
                            <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
