                ...
                <div className="flex flex-wrap -m-4 px-20">
                    ...
                    <div className="lg:w-1/3 lg:mb-0 p-4">
                        <div className="h-full text-center">
                            ...
                            <p className="leading-relaxed">"Dank dieser Plattform habe ich als Zehntklässler eine unglaubliche Veränderung erlebt. AutoTest hat mir geholfen, meine Mathematikkenntnisse zu verbessern und meine Noten von durchschnittlich auf hervorragend zu steigern. Ich muss AutoTest nur zweimal in der Woche nutzen und sehe trotzdem große Fortschritte. Jetzt fühle ich mich viel selbstbewusster und bereit für meine bevorstehenden Prüfungen. Diese Plattform hat mir wirklich geholfen, mein volles Potenzial auszuschöpfen und meine Zukunft in der Schule zu sichern!</p>
                            <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
