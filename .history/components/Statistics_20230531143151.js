...
const Statistic = ({ }) => {
    const SeeReviewsButton = () => (
        <div className="flex justify-center">
            <Link href="/reviews">
                <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">See Full Reviews</button>
            </Link>
        </div>
    );
